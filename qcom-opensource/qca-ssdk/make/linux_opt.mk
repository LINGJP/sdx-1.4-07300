...
ifeq (KSLIB, $(MODULE_TYPE))
  ...
  ifeq ($(OS_VER),$(filter 5_4 4_9 4_1 4_14, $(OS_VER)))
                MODULE_CFLAG += -DKVER34
                MODULE_CFLAG += -DKVER32
            MODULE_CFLAG += -DLNX26_22
	    ifeq ($(ARCH), arm64)
	    KCONF_FILE = $(SYS_PATH)/source/include/linux/kconfig.h
	     ...
	     ifeq ($(BOARD_NAME), BOARD_MDM_LE)
	        GCC_VERSION=$(shell ${CC} -v 2>&1 | tail -n1 | awk '{print $$3}')
	    	KCONF_FILE = $(KERNEL_SRC)/include/linux/kconfig.h
            	MODULE_INC += -I$(SYS_PATH) \
              -I$(TOOL_PATH)/../../lib/arm-oe-linux-gnueabi/gcc/arm-oe-linux-gnueabi/$(GCC_VERSION)/include  \
              -I$(SYS_PATH)/include \
              -I$(SYS_PATH)/source/include \
              -I$(SYS_PATH)/source/arch/arm/include \
              -I$(SYS_PATH)/arch/arm/include \
